...
describe 'pe_winagent', type: :class do
  ...
  #     is_expected.to contain_pe_staging__file('puppet-enterprise-3.3.0.msi').with(source: 'https://s3.amazonaws.com/pe-builds/released/3.3.0/puppet-enterprise-3.3.0.msi',
  ...
  #     is_expected.to contain_pe_staging__file('puppet-enterprise-3.8.0-x64.msi').with(source: 'https://s3.amazonaws.com/pe-builds/released/3.8.0/puppet-enterprise-3.8.0-x64.msi',
